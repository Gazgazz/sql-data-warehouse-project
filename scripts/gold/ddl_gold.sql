...
enriched and business ready data-set

Usage
- These views cvan be queried directly for analytics and reporting
=========================================================================
*/
-- =====================================================================
...
gv.cat AS category,
gv.subcat AS subacategory,
gv.maintenance,
pr.prd_cost AS cost,
pr.prd_line AS product_line,
pr.prd_start_dt AS start_date
FROM silver.crm_prd_info pr
LEFT JOIN silver.erp_px_cat_g1v2 gv
ON pr.cat_id = gv.id 
WHERE pr.prd_end_dte IS NULL;     -- filtering out historical data;
...
SELECT 
	ROW_NUMBER () OVER (ORDER BY cstd_id) AS customer_key,
	ci.cstd_id AS customer_id,
	ci.cst_key AS customer_no,
	ci.cst_firstname AS first_name,
	ci.cst_lastname AS last_name,
    la.cntry AS country,
	ci.cst_marital_status AS marital_status,
	CASE WHEN cst_gndr != 'unknown' THEN ci.cst_gndr
